...
HRESULT CTree::Ready_GameObject(const _tchar * FullPath, const _tchar * FileName, const _tchar * ComPath, const _vec3 & vMakeScale, const _vec3 & vMakePos, const _vec3 & vMakeRot)
{
...
_int CTree::Update_GameObject(const _float & fTimeDelta)
{
	...
	if (nullptr != m_pFrustum)
		m_isDraw = m_pFrustum->isIn_Frustum(&vPosition, 10.f);
...
HRESULT CTree::Ready_MeshComponent(const _tchar * ComPath)
{
	CComponent*			pComponent = nullptr;
...
HRESULT CTree::SetUp_OnConstantTable(LPD3DXEFFECT pEffect)
{
	pEffect->AddRef();
...
CTree * CTree::Create(LPDIRECT3DDEVICE9 pGraphicDev, const _tchar * FullPath, const _tchar * FileName, const _tchar * ComPath, const _vec3 & vMakeScale, const _vec3 & vMakePos, const _vec3 & vMakeRot)
{
