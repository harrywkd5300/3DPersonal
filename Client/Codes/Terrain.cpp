...
HRESULT CTerrain::Ready_Component(void)
{
	...
	// For.Buffers
	pComponent = m_pBufferCom = (Engine::CTerrain_Buffer*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Buffer_Terrain");
	if (nullptr == pComponent)
		return E_FAIL;
	...
	// For.Texture
	pComponent = m_pTextureCom = (Engine::CTexture*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Texture_Terrain");
	if (nullptr == pComponent)
		return E_FAIL;
	...
	//// For.Texture
	//pComponent = m_pTextureNormalCom = (Engine::CTexture*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Texture_Rocks_Normal");
	//if (nullptr == pComponent)
	//	return E_FAIL;
	//m_mapComponent[Engine::CComponent::TYPE_STATIC].insert(MAPCOMPONENT::value_type(L"Com_TextureNormal", pComponent));
	//m_pTextureNormalCom->AddRef();


	//// For.Texture
	//pComponent = m_pTextureCom = (Engine::CTexture*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Texture_Floor1_d");
	//if (nullptr == pComponent)
	//	return E_FAIL;
	//m_mapComponent[Engine::CComponent::TYPE_STATIC].insert(MAPCOMPONENT::value_type(L"Com_Texture", pComponent));
	//m_pTextureCom->AddRef();
	...
	// For.Texture
	pComponent = m_pTextureTowerRangeCom = (Engine::CTexture*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Texture_TowerRadius");
	if (nullptr == pComponent)
		return E_FAIL;
	...
	// For. Texture
	pComponent = m_pDestCom0 = (Engine::CTexture*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Texture_SnowBase");
	if (nullptr == pComponent)
		return E_FAIL;
	...
	// For. Texture
	pComponent = m_pDestCom1 = (Engine::CTexture*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Texture_Rocks");
	if (nullptr == pComponent)
		return E_FAIL;
	...
	// For. Texture
	pComponent = m_pDestCom2 = (Engine::CTexture*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Texture_Multi0");
	if (nullptr == pComponent)
		return E_FAIL;
	...
	// For.Shader
	pComponent = m_pShader = (Engine::CShader*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"Component_Shader_Terrain");
	if (nullptr == pComponent)
		return E_FAIL;
...
HRESULT CTerrain::Ready_Filter()
{
	HANDLE hFile = CreateFile(L"../Bin/Data/Test.dat", GENERIC_READ, NULL, NULL, OPEN_EXISTING
		, FILE_ATTRIBUTE_NORMAL, NULL);
	...
	if (FAILED(D3DXCreateTexture(m_pGraphicDev, UINT(vecFilter.x), UINT(vecFilter.y), UINT(vecFilter.z), 0, D3DFMT_A8R8G8B8, D3DPOOL_MANAGED, &m_pFilterTexture)))
		return E_FAIL;
...
HRESULT CTerrain::SetUp_OnContantTable(LPD3DXEFFECT pEffect)
{
	pEffect->AddRef();
