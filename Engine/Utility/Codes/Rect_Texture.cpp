...
HRESULT CRect_Texture::Ready_Buffer(void)
{
	...
	pVertex[0].vPosition = _vec3(-1.0f, 1.0f, 0.0f);
	pVertex[0].vTexUV = _vec2(0.0f, 0.f);

	pVertex[1].vPosition = _vec3(1.0f, 1.0f, 0.0f);
	pVertex[1].vTexUV = _vec2(1.f, 0.f);

	pVertex[2].vPosition = _vec3(1.0f, -1.0f, 0.0f);
	pVertex[2].vTexUV = _vec2(1.f, 1.f);

	pVertex[3].vPosition = _vec3(-1.0f, -1.0f, 0.0f);
